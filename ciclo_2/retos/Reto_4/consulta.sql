...
SELECT * FROM escuela;
SELECT 'Consulta 2';
SELECT pocion.codigo_pocion, pocion.nombre_pocion, pocion.reg_litros, pocion.num_utilizado, escuela.nombre_escuela, escuela.habilidad_principal FROM pocion JOIN escuela 
